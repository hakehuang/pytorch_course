# -*- coding: utf-8 -*-
"""
Created on Fri Dec 27 19:13:43 2019
...
def main():
    ...
    torch.save(model.state_dict(), "./data_detect")
    print("That's it!")
...
def load_check():
    ...
    num_classes = 2
    model = get_model_instance_segmentation(num_classes)
    model.load_state_dict(torch.load("./data_detect"))
